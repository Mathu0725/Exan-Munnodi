...
export default function TamilDemo() {
  const tamilExamples = {
    ...
    question: "இந்த கேள்விக்கு பதில் என்ன? (What is the answer to this question?)",
  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-lg space-y-6">
      <h2 className="text-2xl font-bold text-gray-800 mb-4">Tamil Font Support Demo</h2>
      
      <div className="space-y-4">
        <div>
          <h3 className="text-lg font-semibold text-gray-700 mb-2">Heading Style</h3>
        ...
        <div>
          <h3 className="text-lg font-semibold text-gray-700 mb-2">Question Style</h3>
        ...
        <div>
          <h3 className="text-lg font-semibold text-gray-700 mb-2">Option Style</h3>
        ...
        <div>
          <h3 className="text-lg font-semibold text-gray-700 mb-2">Body Text Style</h3>
        ...
        <div>
          <h3 className="text-lg font-semibold text-gray-700 mb-2">Search Highlighting</h3>
          <TamilText 
            type="body" 
            className="text-base"
            searchTerm="தமிழ்"
