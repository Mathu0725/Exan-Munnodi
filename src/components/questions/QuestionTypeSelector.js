...
const questionTypes = [
  {
    ...
    description: 'Traditional multiple choice questions with options A, B, C, D',
    icon: '📝',
...
export default function QuestionTypeSelector({ onSave, onCancel, initialData = null }) {
  const [selectedType, setSelectedType] = useState(initialData?.question_type || null);
