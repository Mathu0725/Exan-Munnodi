  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      for (let i = 0; i < 6; i++) {
        ...
        const y =
          centerY + Math.sin(angle) * radius + Math.sin(time * 1.5 + i) * 40;
      ...
      for (let i = 0; i < 8; i++) {
        ...
        const x = centerX + Math.cos(angle) * radius;
        const y =
          centerY + Math.sin(angle) * radius + Math.sin(time * 1.2 + i) * 25;
      ...
      for (let i = 0; i < 4; i++) {
        ...
        const x = centerX + Math.cos(angle) * radius;
        const y =
          centerY + Math.sin(angle) * radius + Math.sin(time * 1.3 + i) * 50;
