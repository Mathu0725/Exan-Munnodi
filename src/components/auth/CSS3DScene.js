    ...
    <div className="w-full h-full relative overflow-hidden">
      <style jsx>{`
        ...
        @keyframes floatCalculator {
          ...
          66% { transform: translateY(-35px) rotate(-2deg); }
        }
        ...
        .floating-document:nth-child(1) { top: 10%; left: 10%; }
        .floating-document:nth-child(2) { top: 20%; left: 80%; }
        .floating-document:nth-child(3) { top: 60%; left: 15%; }
        .floating-document:nth-child(4) { top: 70%; left: 85%; }
        .floating-document:nth-child(5) { top: 40%; left: 5%; }
        .floating-document:nth-child(6) { top: 80%; left: 70%; }

        .floating-pencil:nth-child(7) { top: 15%; left: 20%; }
        .floating-pencil:nth-child(8) { top: 25%; left: 75%; }
        .floating-pencil:nth-child(9) { top: 65%; left: 25%; }
        .floating-pencil:nth-child(10) { top: 75%; left: 80%; }

        .floating-calculator:nth-child(11) { top: 30%; left: 30%; }
        .floating-calculator:nth-child(12) { top: 50%; left: 60%; }
        .floating-calculator:nth-child(13) { top: 80%; left: 40%; }

        .floating-book:nth-child(14) { top: 35%; left: 10%; }
        .floating-book:nth-child(15) { top: 45%; left: 90%; }
        .floating-book:nth-child(16) { top: 75%; left: 20%; }
        .floating-book:nth-child(17) { top: 85%; left: 80%; }

        .floating-laptop:nth-child(18) { top: 20%; left: 50%; }
        .floating-laptop:nth-child(19) { top: 60%; left: 50%; }

        .floating-chart:nth-child(20) { top: 10%; left: 60%; }
        .floating-chart:nth-child(21) { top: 40%; left: 80%; }
        .floating-chart:nth-child(22) { top: 70%; left: 60%; }
      `}</style>
