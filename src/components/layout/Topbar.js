        ...
        <div className="flex items-center gap-3">
          ...
          >
            <svg className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
              <path fillRule="evenodd" d="M3 5a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 10a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM4 14a1 1 0 100 2h12a1 1 0 100-2H4z" clipRule="evenodd" />
            </svg>
          </button>
          <div>
            <p className="text-xs uppercase tracking-wide text-gray-400 dark:text-gunmetal-200">Overview</p>
            <h2 className="text-xl font-semibold text-gray-900 dark:text-midnight-50">{title}</h2>
          </div>
        </div>
          ...
          {user && (
            <span className="hidden sm:inline-flex items-center gap-2 rounded-md bg-gray-100 px-3 py-2 text-gray-700 dark:bg-gunmetal-800 dark:text-midnight-100">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs text-gray-500 dark:text-gunmetal-200 capitalize">{user.role}</span>
              </div>
            </span>
          )}
          <CompactThemeToggle />
