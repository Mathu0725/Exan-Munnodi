  ...
  const menuItems = [
    {
      name: 'Dashboard',
      path: '/',
      roles: ['Admin', 'Content Editor', 'Reviewer', 'Analyst', 'Student'],
    },
    {
      name: 'Subjects',
      path: '/subjects',
      roles: ['Admin', 'Content Editor', 'Reviewer', 'Analyst'],
    },
    {
      name: 'Categories',
      path: '/categories',
    ...
    },
    {
      name: 'Question Bank',
      path: '/questions',
      roles: ['Admin', 'Content Editor', 'Reviewer'],
    },
    {
      name: 'Exams',
      path: '/exams',
      ...
      <div className='flex items-center justify-between gap-3'>
        <div className='flex items-center gap-3'>
          ...
          <div>
            ...
            <p className='text-xs text-gray-500 dark:text-gunmetal-200'>
              Admin Console
            </p>
          </div>
        </div>
