...
export default function Step3Configure({ data, onBack, onSubmit }) {
  ...
  const handleFormSubmit = configData => {
    const payload = {
      ...configData,
      total_time_minutes: configData.total_time_minutes
        ? parseInt(configData.total_time_minutes, 10)
        : null,
    };
    onSubmit(payload);
  };
          ...
          <div className='space-y-6'>
            ...
            <div>
              ...
              >
                ...
                <option value='per_question_time'>
                  Sum of Individual Question Times
                </option>
              </select>
            </div>
            ...
            <div>
              ...
              <p className='text-xs text-gray-500 mt-1'>
                Students must enter this to start the exam.
              </p>
            </div>
          </div>
