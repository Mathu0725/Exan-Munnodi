...
export default function ResetWithOtpPage() {
  ...
  const onSubmit = async ({ email, otp, password }) => {
    ...
    try {
      ...
      setSuccessMessage(payload?.message || 'Password updated successfully. You can now log in.');
    } catch (err) {
    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4 py-12">
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          <h1 className="text-3xl font-bold text-gray-900">Reset password with OTP</h1>
