    ...
    return (
      <PageWrapper title="Access Denied">
        <div className="text-center py-12">
          <p className="text-red-500">Only Super Admin can create staff members.</p>
        </div>
      </PageWrapper>
    );
  }
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-md p-4">
              ...
              <div className="text-sm text-blue-700 space-y-1">
                <p><strong>Admin:</strong> Full system access, user management, all features</p>
                <p><strong>Content Editor:</strong> Question bank, exams, student groups</p>
                <p><strong>Reviewer:</strong> View and review content, limited editing</p>
                <p><strong>Analyst:</strong> View reports and analytics, read-only access</p>
              </div>
            </div>
